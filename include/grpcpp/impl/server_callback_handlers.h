...
class CallbackUnaryHandler : public MethodHandler {
  public:
    explicit CallbackUnaryHandler(
        std::function<
            ServerUnaryReactor*(CallbackServerContext*, const RequestType*, ResponseType*)>
            func
    )
        : func_(std::move(func)) {}
  ...
  private:
    std::function<ServerUnaryReactor*(CallbackServerContext*, const RequestType*, ResponseType*)>
        func_;
};
