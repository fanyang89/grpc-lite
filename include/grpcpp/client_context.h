...
class ClientContext {
  public:
    ...
    const std::vector<std::pair<std::string, std::string>>& GetServerInitialMetadata() const {
        return server_initial_metadata_;
    }

    const std::vector<std::pair<std::string, std::string>>& GetServerTrailingMetadata() const {
        return server_trailing_metadata_;
    }

    void SetServerInitialMetadata(std::vector<std::pair<std::string, std::string>> md) {
        server_initial_metadata_ = std::move(md);
    }

    void SetServerTrailingMetadata(std::vector<std::pair<std::string, std::string>> md) {
