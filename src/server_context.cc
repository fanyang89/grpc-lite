...
const std::vector<ServerContext::MetadataEntry>& ServerContext::initial_metadata() const {
    return initial_metadata_;
}

const std::vector<ServerContext::MetadataEntry>& ServerContext::trailing_metadata() const {
